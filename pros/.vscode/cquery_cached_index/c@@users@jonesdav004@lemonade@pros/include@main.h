...
#define QUAD_LEFT_TOP
#define QUAD_LEFT_BOTTOM
#define QUAD_RIGHT_TOP
#define QUAD_RIGHT_BOTTOM

Encoder encLeft;
Encoder encRight;


//declare ints for joystick
int joyLeft;
int joyRight;

//declare pneumatics function
//pneumatics Function Base Level
void pneumaticsFunc(bool power){
	digitalWrite(9, power);
}

//pneumatics Middle Level
//pneumatics stop
void pneumaticsDown(){
	pneumaticsFunc(0);
}
