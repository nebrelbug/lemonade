...
#pragma config(Motor,  port3,           right1,        tmotorVex393HighSpeed_MC29, PIDControl, reversed, driveLeft, encoderPort, dgtl1)
#pragma config(Motor,  port4,           right2,        tmotorVex393HighSpeed_MC29, PIDControl, reversed, driveLeft, encoderPort, dgtl1)
#pragma config(Motor,  port5,           right3,        tmotorVex393HighSpeed_MC29, PIDControl, reversed, driveLeft, encoderPort, dgtl1)
#pragma config(Motor,  port6,           left1,         tmotorVex393HighSpeed_MC29, PIDControl, reversed, driveRight, encoderPort, dgtl3)
#pragma config(Motor,  port7,           left2,         tmotorVex393HighSpeed_MC29, PIDControl, reversed, driveRight, encoderPort, dgtl3)
#pragma config(Motor,  port8,           left3,         tmotorVex393HighSpeed_MC29, PIDControl, reversed, driveRight, encoderPort, dgtl3)
